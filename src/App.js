...
function App() {
  const followersList = [
    {
      name: "Kaiser",
      avatar:
        "https://orig00.deviantart.net/8384/f/2007/302/0/9/random_head_profile_by_kurvos.png",
    },
    {
      name: "Sheeran",
      avatar:
        "https://i.imagesup.co/images2/42736a080ed7a88afcf537cb6309cbe3d037e878.jpg",
    },
    {
      name: "Kaiser",
      avatar:
  ...
  const Posts = [
    {
      postMediaLink:
        "https://th.bing.com/th/id/R.8486fc5ea4e6586190a49a4d91170ea8?rik=kISlrokwfE3CRg&pid=ImgRaw&r=0",
      postMeta: "Ice cream joy",
      avatar:
        "https://th.bing.com/th/id/OIP.onvo20gh0-YyVWDiLcICowHaHa?pid=ImgDet&w=512&h=512&rs=1",
      name: "John Doe",
